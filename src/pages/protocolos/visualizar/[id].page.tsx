...
export default function Vizualizar({ data }: schemaEmpresasProps) {
  ...
  const formatDate = (date: number, partDate: string) => {
    ...
    var dt_day = dt.getDay() + 1 < 10 ? "0"+ dt.getDay() : dt.getDay();
    var dt_month = dt.getMonth() + 1 < 10 ? "0"+ (dt.getMonth() + 1) : dt.getMonth() + 1;
    ...
    var dtReturn = dt_year+'-'+dt_month+'-'+dt_day;
    ...
    <Container>
      <form>
        ...
        <fieldset>
          ...
          <Box>
            <div style={{ width: '10%' }}>
              <TextInput title="Número de Protocolo" value={data.num_protocolo} />
            </div>
            <TextInput title="Tipo Protocolo" w={200} value={data.tipo_protocolo} />
          </Box>
            
          <Box>
            <TextInput title="Assunto Protocolo" w={500} value={data.assunto_protocolo} />
          </Box>
          ...
          <Box>
            ...
            <div>
              <TextInput title="Dia" w={100} value={formatDate(data.data_recebimento, 'day')}/>
            </div>

            <div>
              <TextInput title="Mês" w={100} value={formatDate(data.data_recebimento, 'month')}/>
            </div>

            <div>
              <TextInput title="Ano" w={100} value={formatDate(data.data_recebimento, 'year')}/>
            </div>


            <div>
              <TextInput title="Meio de Recebimento" w={225} value={data.meio_recebimento} />
            </div>
            <div style={{ width: '15%' }}>
              <SwitchInput
          ...
          <Box>
            ...
            <div>
              <TextInput title="Dia" w={100} value={formatDate(data.data_envio, 'day')}/>
            </div>

            <div>
              <TextInput title="Mês" w={100} value={formatDate(data.data_envio, 'month')}/>
            </div>

            <div>
              <TextInput title="Ano" w={100} value={formatDate(data.data_envio, 'year')}/>
            </div>
            <div>
              <TextInput title="Meio de Envio" w={225} value={data.meio_envio} />
            </div>          
          </Box>
          ...
          <Box>
            ...
            <div>
              <TextInput title="Dia" w={100} value={formatDate(data.data_encerramento_protocolo, 'day')}/>
            </div>

            <div>
              <TextInput title="Mês" w={100} value={formatDate(data.data_encerramento_protocolo, 'month')}/>
            </div>

            <div>
              <TextInput title="Ano" w={100} value={formatDate(data.data_encerramento_protocolo, 'year')}/>
            </div>
            <div style={{ width: '30%' }}>
              <TextInput title="Usuário Encerramento Protocolo" value={data.usuario_encerramento_protocolo} />
            </div>          
          </Box>
